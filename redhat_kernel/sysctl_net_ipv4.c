...
static unsigned int tcp_leo_port_max = 65535;
...
static struct ctl_table ipv4_net_table[] = {
	...
	{
		.procname	= "tcp_leo_rwnd_enable",
		.data		= &init_net.ipv4.sysctl_tcp_leo_rwnd_enable,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_rwnd_period_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_rwnd_period_ms,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_rwnd_offset_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_rwnd_offset_ms,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
	{
		.procname	= "tcp_leo_rwnd_pre_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_rwnd_pre_ms,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
	{
		.procname	= "tcp_leo_rwnd_outage_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_rwnd_outage_ms,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec,
	},
	{
		.procname	= "tcp_leo_rwnd_min_segs",
		.data		= &init_net.ipv4.sysctl_tcp_leo_rwnd_min_segs,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_rwnd_debug",
		.data		= &init_net.ipv4.sysctl_tcp_leo_rwnd_debug,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_rwnd_recovery_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_rwnd_recovery_ms,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_rwnd_fast_recovery",
		.data		= &init_net.ipv4.sysctl_tcp_leo_rwnd_fast_recovery,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_dynamic_enable",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_enable,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_dynamic_sample_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_sample_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_dynamic_freeze_guard_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_freeze_guard_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_dynamic_pre_min_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_pre_min_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_dynamic_pre_max_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_pre_max_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_dynamic_outage_min_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_outage_min_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_dynamic_outage_max_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_outage_max_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_dynamic_outage_guard_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_outage_guard_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_dynamic_drain_min_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_drain_min_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
		...
		{
		.procname	= "tcp_leo_dynamic_drain_max_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_drain_max_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_dynamic_fallback_rtt_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_fallback_rtt_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_dynamic_fallback_rate_mbps",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_fallback_rate_mbps,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_dynamic_ewma_shift",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_ewma_shift,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_dynamic_allow_port1",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_allow_ports[0],
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ZERO,
		.extra2 = &tcp_leo_port_max,
	},
		{
		.procname	= "tcp_leo_dynamic_allow_port2",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_allow_ports[1],
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ZERO,
		...
		{
		.procname	= "tcp_leo_dynamic_allow_port3",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_allow_ports[2],
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ZERO,
		...
		{
		.procname	= "tcp_leo_dynamic_allow_port4",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_allow_ports[3],
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_dynamic_prediction_guard_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_prediction_guard_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_douintvec_minmax,
		.extra1		= SYSCTL_ONE,
	...
	{
		.procname	= "tcp_leo_dynamic_pred_guard_to_outage",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_pred_guard_to_outage,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_dynamic_recovery_enable",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_recovery_enable,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "tcp_leo_dynamic_recovery_min_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_recovery_min_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
		...
		{
		.procname	= "tcp_leo_dynamic_recovery_max_ms",
		.data		= &init_net.ipv4.sysctl_tcp_leo_dynamic_recovery_max_ms,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
