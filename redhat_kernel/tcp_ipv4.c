...
static int __net_init tcp_sk_init(struct net *net)
{
	...
	net->ipv4.sysctl_tcp_shrink_window = 1;

	net->ipv4.sysctl_tcp_pingpong_thresh = 1;

	// LEO rwnd control parameters
	net->ipv4.sysctl_tcp_leo_rwnd_enable = 1;
	net->ipv4.sysctl_tcp_leo_rwnd_period_ms = 15000;
	net->ipv4.sysctl_tcp_leo_rwnd_offset_ms = 12000;
	net->ipv4.sysctl_tcp_leo_rwnd_pre_ms = 150;
	net->ipv4.sysctl_tcp_leo_rwnd_outage_ms = 100;
	net->ipv4.sysctl_tcp_leo_rwnd_min_segs = 4;
	net->ipv4.sysctl_tcp_leo_rwnd_debug = 1;
	net->ipv4.sysctl_tcp_leo_rwnd_recovery_ms=0;
	net->ipv4.sysctl_tcp_leo_rwnd_fast_recovery=1;

	net->ipv4.sysctl_tcp_leo_dynamic_enable = 1;
	net->ipv4.sysctl_tcp_leo_dynamic_sample_ms = 50;
	net->ipv4.sysctl_tcp_leo_dynamic_freeze_guard_ms = 50;

	net->ipv4.sysctl_tcp_leo_dynamic_pre_min_ms = 20;
	net->ipv4.sysctl_tcp_leo_dynamic_pre_max_ms = 300;

	net->ipv4.sysctl_tcp_leo_dynamic_outage_min_ms = 10;
	net->ipv4.sysctl_tcp_leo_dynamic_outage_max_ms = 80;
	net->ipv4.sysctl_tcp_leo_dynamic_outage_guard_ms = 5;

	net->ipv4.sysctl_tcp_leo_dynamic_drain_min_ms = 10;
	net->ipv4.sysctl_tcp_leo_dynamic_drain_max_ms = 80;

	net->ipv4.sysctl_tcp_leo_dynamic_fallback_rtt_ms = 70;
	net->ipv4.sysctl_tcp_leo_dynamic_fallback_rate_mbps = 250;
	net->ipv4.sysctl_tcp_leo_dynamic_ewma_shift = 3;

	net->ipv4.sysctl_tcp_leo_dynamic_allow_ports[0] = 20075;
	net->ipv4.sysctl_tcp_leo_dynamic_allow_ports[1] = 20076;
	net->ipv4.sysctl_tcp_leo_dynamic_allow_ports[2] = 0;
	net->ipv4.sysctl_tcp_leo_dynamic_allow_ports[3] = 0;

	net->ipv4.sysctl_tcp_leo_dynamic_prediction_guard_ms = 30;
	net->ipv4.sysctl_tcp_leo_dynamic_pred_guard_to_outage = 1;

	net->ipv4.sysctl_tcp_leo_dynamic_recovery_min_ms = 20;
	net->ipv4.sysctl_tcp_leo_dynamic_recovery_max_ms = 80;
	net->ipv4.sysctl_tcp_leo_dynamic_recovery_enable = 1;
